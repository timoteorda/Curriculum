    ...
    <div className='presentacion'>
      <div className='informacionTimoteo'>
          ...
          <div className='infoPersonal'>
            ...
            <p className='parrafoPresentacionDos'>Ya, en 2022 y gracias al interés que me genero dicho curso decidí ingresar en la carrera de Licenciatura en Sistemas, la cual me encuentro cursando.</p>
